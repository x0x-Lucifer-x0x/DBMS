...
class Login:
    def __init__(self, window):
        ...
        #Login label
        self.l1 = Label(text="Username",bg="#f6f6f6", font=('Arial', 13))
        ...
        #Password label
        self.l2 = Label(text="Password",bg="#f6f6f6", font=('Arial', 13))
        ...
        #Forgot_pwd Button
        self.f_pwd = Button(text="forgot password?",command=f_pwd,bd=0, fg="Black",underline=0 ,relief='flat', cursor="hand2",bg="#f6f6f6")
